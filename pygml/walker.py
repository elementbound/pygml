...
class SubscriptVisitor(ast.NodeVisitor):
    ...
    visit_Slice = _raiseunsupported("Slicing is not supported")
    visit_ExtSlice = _raiseunsupported("Slicing is not supported")


class ExpressionWalker(LiteralsVisitor, OperatorsVisitor, SubscriptVisitor):
